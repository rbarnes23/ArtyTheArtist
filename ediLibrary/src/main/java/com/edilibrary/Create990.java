...
public class Create990 extends EdiSupport {

	// Response to a Load Tender
	public String create990(JSONObject JSONShipment, String shipmentStatus,
		...
		X12_990 += createISA(authorizationQualifier, authorizationInformation,
		...
		X12_990 += createGS(functionalIdentifierCode, applicationSendersCode,
				applicationReceiversCode, cDate, cTime, groupControlNo,
				responsibleAgencyCode, industryIdentifierCode);
		X12_990 += createST(transactionsetControlNo, "990");
		X12_990 += createB1(standardCarrierAlphaCode, shipmentId,
				shipmentStatus);
		X12_990 += createN9(shipmentId);
		// X12_990 += createG62(shipmentId);
		X12_990 += createN7(equipmentNumber, equipmentCode, equipmentLength,
				equipmentType);
		X12_990 += createK1(driverName, driverNo);

		X12_990 += createSE(transactionsetControlNo);
		X12_990 += createGE(transactionsetControlNo);
		X12_990 += createIEA(transactionsetControlNo);
