...
public class Create210 extends EdiSupport {

	// Response to a Load Tender
	public String create210(JSONObject JSONShipment, String shipmentStatus,
		...
		X12_210 += createISA(authorizationQualifier, authorizationInformation,
		...
		X12_210 += createGS(functionalIdentifierCode, applicationSendersCode,
				applicationReceiversCode, cDate, cTime, groupControlNo,
				responsibleAgencyCode, industryIdentifierCode);
		X12_210 += createST(transactionsetControlNo, "210");
		X12_210 += createB1(standardCarrierAlphaCode, shipmentId,
				shipmentStatus);
		X12_210 += createN9(shipmentId);
		// X12_210 += createG62(shipmentId);
		X12_210 += createN7(equipmentNumber, equipmentCode, equipmentLength,
				equipmentType);
		X12_210 += createK1(driverName, driverNo);

		X12_210 += createSE(transactionsetControlNo);
		X12_210 += createGE(transactionsetControlNo);
		X12_210 += createIEA(transactionsetControlNo);
